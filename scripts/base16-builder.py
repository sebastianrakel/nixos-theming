...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='base16-builder')
    parser.add_argument('--template_list', default='https://raw.githubusercontent.com/sebastianrakel/base16-templates-source/patch-1/list.yaml')
    parser.add_argument('--scheme_list', default='https://raw.githubusercontent.com/chriskempson/base16-schemes-source/master/list.yaml')
